...
new TypeIt("#teks1", {
  strings: [
    "Hari ini aku berdoa agar semua hal baik selalu datang untukmu.",
    "Semoga apa pun yang kamu hadapi bisa kamu jalani dengan hati yang kuat dan tenang.",
    "Semoga kesehatan selalu menyertaimu, agar kamu bisa terus melakukan hal-hal yang kamu cintai.",
    "Semoga kedamaian dan kebahagiaan hadir di setiap langkahmu, dari pagi sampai malam.",
    "Terima kasih sudah menjadi istri yang sabar, pengertian, dan selalu mendukungku dalam segala keadaan.",
    "Terima kasih karena kamu tetap bertahan meskipun banyak hal tidak mudah kamu jalani.",
  ],
  startDelay: 6000,
  speed: 75,
...
new TypeIt("#teks2", {
  strings: [
    "Aku berharap setiap rencanamu dimudahkan dan setiap harimu terasa lebih ringan.",
    "Terima kasih karena kamu sudah bertahan sejauh ini, dengan segala tantangan dan cerita yang kamu bawa.",
    "Terima kasih sudah menjadi tempat pulang yang selalu menenangkan untukku.",
    "Barakallah fii umrik, sayang. Semoga usia yang bertambah membawa banyak keberkahan.",
    "Semoga apa pun yang kamu inginkan, selama itu baik, Allah wujudkan dengan cara terbaik.",
    "- Dari suamimu. Isal",
  ],
  startDelay: 5000,
  speed: 75,
